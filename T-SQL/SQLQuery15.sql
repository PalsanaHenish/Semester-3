...
SELECT AUTHORNAME, COUNT(BOOKID) AS COUNT_BOOK
FROM BOOK B
RIGHT JOIN AUTHOR A
ON B.AUTHORID = A.AUTHORID
GROUP BY AUTHORNAME
...
SELECT AUTHORNAME, COUNT(BOOKID) AS COUNT_BOOK, AVG(PRICE) AS AVG_PRICE
FROM BOOK B
RIGHT JOIN AUTHOR A
ON B.AUTHORID = A.AUTHORID
GROUP BY AUTHORNAME
...
--lowest. 
SELECT PUBLISHERNAME, COUNT(BOOKID) AS TOTAL_BOOKS_PUBLISHED
FROM BOOK B
JOIN PUBLISHER P
ON B.PUBLISHERID = P.PUBLISHERID
GROUP BY PUBLISHERNAME
...
SELECT PUBLICATIONYEAR, COUNT(BOOKID) AS TOTAL_BOOKS_PUBLISHED
FROM BOOK
...
SELECT AUTHORNAME, MAX(PRICE) AS EXPENCIVE
FROM BOOK B
JOIN AUTHOR A
...
SELECT E1.NAME AS MANAGER_NAME , COUNT(E2.EMPLOYEENO)
FROM EMPLOYEE_MASTER E1
JOIN EMPLOYEE_MASTER E2
ON E1.EMPLOYEENO = E2.MANAGERNO
GROUP BY E1.NAME
