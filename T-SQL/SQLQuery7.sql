...
SELECT * 
FROM EMPLOYEE
WHERE CAST(JOININGYEAR AS VARCHAR(15)) LIKE '%[46]'
...
SELECT * 
FROM EMPLOYEE
WHERE CAST(JOININGYEAR AS VARCHAR(10)) LIKE '%6' AND CITY LIKE '%RA%' AND SALARY < 13000
...
SELECT * 
FROM EMPLOYEE
WHERE FIRSTNAME LIKE '[^AEIOU]%' AND CITY IS NOT NULL AND NOT DEPARTMENT IN ('HR', 'IT')
