...
SELECT * FROM STUDENT
WHERE CITY IS NOT NULL AND BRANCH IS NULL
...
SELECT * FROM STUDENT
WHERE SPI > 7.5 AND NOT STDID BETWEEN 102 AND 107
...
--7.0. 
SELECT * FROM STUDENT
WHERE CITY != 'RAJKOT' AND BRANCH = 'COMPUTER' AND SPI > 7
...
SELECT STDID, SNAME, CITY FROM STUDENT
