...
FROM EMPLOYEE
GROUP BY CITY
HAVING COUNT(CASE WHEN GENDER='MALE' THEN EID ELSE NULL END)
>
COUNT(CASE WHEN GENDER='FEMALE' THEN EID ELSE NULL END)
...
FROM EMPLOYEE
GROUP BY DEPARTMENT
HAVING SUM(CASE WHEN GENDER='MALE' THEN SALARY ELSE NULL END)
>
SUM(CASE WHEN GENDER='FEMALE' THEN SALARY ELSE NULL END)